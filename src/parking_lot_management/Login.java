...
public class Login {
	...
	public static void main(String[] args) {
		...
		main.setBounds(1200, 50, 500, 800);
		main.setLayout(null);
		...
		login.setBounds(1200, 50, 500, 800);
		...
		idS.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				String findNameText = JOptionPane.showInputDialog(null, "회원가입 시 사용한 이름을 입력해 주세요.", "ID 찾기",
		...
		profile.setBounds(1200, 50, 500, 800);
		profile.setLayout(null);// 자동배치 끄기
		profile.setResizable(false);
		
		// 뒤로가기 버튼
		ImageIcon profile_back_button = new ImageIcon("backbtn.png");
		JButton backbtn = new JButton();
		backbtn.setIcon(profile_back_button);
		backbtn.setBounds(25, 45, 50, 50);
		...
		// 회원정보 페이지 프로필 이미지 버튼
		JButton ppbtn = new JButton();
		ppbtn.setBounds(50, 70, 100, 100);
		ppbtn.setBorderPainted(false);
		...
		pcbtn.setBounds(200, 600, 100, 50);
		pcbtn.setFont(fo);
		...
		String profilename = regname.getText();
		...
		drawer.setBounds(1200, 50, 500, 800);
		...
		// 예약하기 버튼
		ImageIcon booking_img = new ImageIcon("booking.png");
		JButton booking = new JButton();
		booking.setIcon(booking_img);
		booking.setBounds(200, 675, 100, 40);
		...
		choose.setBounds(1200, 50, 500, 800);
		...
		regokbtn.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (regname.getText().trim().length() == 0) {
					...
					Font profile_namefont = new Font(Font.SANS_SERIF, Font.BOLD, 50);
					JLabel profile_name = new JLabel(j.getName());
					profile_name.setBounds(155, 100, 400, 50);
					profile_name.setFont(profile_namefont);
...
//						idCheck = true;
		...
		pay.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				JOptionPane.showMessageDialog(null,
						"주차권 : " + parkingticket.getText() + "000원\n쿠폰 : " + coupon.getText() + "00원\n충전금 : "
		...
		pic1btn.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				profilebtn.setFocusPainted(false);
				profilebtn.setContentAreaFilled(false);
				ppbtn.setIcon(pic1btn.getIcon());
				JButton ppbtn = new JButton();
				ppbtn.setBounds(300, 50, 100, 100);
				ppbtn.setBorderPainted(false);
				ppbtn.setFocusPainted(false);
				ppbtn.setContentAreaFilled(false);
				profile.add(ppbtn);
